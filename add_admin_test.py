def add_admin(page, admin_data):
    ...
    page.locator("//input[@name='firstName']").fill(admin_data["first_name"])
    page.locator("//input[@name='lastName']").fill(admin_data["last_name"])
    page.locator("//input[@name='contactNo']").fill(admin_data["contact_number"])
    page.locator("//input[@name='email']").fill(admin_data["email"])
    page.locator(f"//input[@value='{admin_data['gender'].lower()}']").click()  # Gender

    # Fill in Login Information
    page.locator("//input[@name='userName']").fill(admin_data["username"])
    page.locator("//input[@name='password']").fill(admin_data.get("password", ""))
